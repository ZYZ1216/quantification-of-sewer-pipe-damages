import unittest
import numpy as np
from quantifiers.connection import ConnectionQuantifier

class TestConnectionQuantifier(unittest.TestCase):
    def setUp(self):
        self.quantifier = ConnectionQuantifier()
    ...
    def test_quantify(self):
        ...
        self.assertIn("protrusion_mm", result)
