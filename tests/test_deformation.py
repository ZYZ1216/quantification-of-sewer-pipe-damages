import unittest
import numpy as np
from quantifiers.deformation import DeformationQuantifier

class TestDeformationQuantifier(unittest.TestCase):
    def setUp(self):
        self.quantifier = DeformationQuantifier()
    ...
    def test_quantify(self):
        ...
        self.assertIn("distortion_percent", result)
