import unittest
import numpy as np
from quantifiers.obstacle import ObstacleQuantifier

class TestObstacleQuantifier(unittest.TestCase):
    def setUp(self):
        self.quantifier = ObstacleQuantifier()
    ...
    def test_quantify(self):
        ...
        self.assertIn("relative_size", result)
