import unittest
import numpy as np
from quantifiers.material_loss import MaterialLossQuantifier

class TestMaterialLossQuantifier(unittest.TestCase):
    def setUp(self):
        self.quantifier = MaterialLossQuantifier()
    ...
    def test_quantify(self):
        ...
        self.assertIn("wall_loss_percent", result)
