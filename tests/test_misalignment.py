import unittest
import numpy as np
from quantifiers.misalignment import MisalignmentQuantifier

class TestMisalignmentQuantifier(unittest.TestCase):
    def setUp(self):
        self.quantifier = MisalignmentQuantifier()
    ...
    def test_quantify(self):
        ...
        self.assertIn("deviation_mm", result)
