import unittest
import numpy as np
from quantifiers.break import BreakQuantifier

class TestBreakQuantifier(unittest.TestCase):
    def setUp(self):
        self.quantifier = BreakQuantifier()
    ...
    def test_quantify(self):
        ...
        self.assertIn("missing_part_percent", result)
