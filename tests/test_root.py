import unittest
import numpy as np
from quantifiers.root import RootQuantifier

class TestRootQuantifier(unittest.TestCase):
    def setUp(self):
        self.quantifier = RootQuantifier()
    ...
    def test_quantify(self):
        ...
        self.assertIn("blockage_percent", result)
